...
public class CalculatorSeleniumTest {
    ...
    public static void  main(String args[]){
       ...
       baseUrl = "https://www.calculator.net/";
        ...
        multiply.oneButton(driver);
        multiply.MultiplyButton(driver);
        multiply.twoButton(driver);
        multiply.MultiplyButton(driver);
        multiply.threeButton(driver);
        multiply.MultiplyButton(driver);
        multiply.fourButton(driver);
        multiply.MultiplyButton(driver);
        multiply.fiveButton(driver);
        multiply.MultiplyButton(driver);
        multiply.sixButton(driver);
        multiply.MultiplyButton(driver);
        multiply.sevenButton(driver);
        multiply.MultiplyButton(driver);
        multiply.eightButton(driver);
        multiply.MultiplyButton(driver);
        multiply.nineButton(driver);
        multiply.printText(driver);
